        ...
        <div class="tab-menu">
          ...
          <div class="tab-content">
            <div id="vision" class="container tab-pane active"><br>
              <p class="text-justify"><i class="fas fa-hand-point-right"></i> Roya Foundation fosters charitable giving to alleviate the needs of poor communities and to establish long-term projects so that their lives are transformed.</p><br><br><br><br><br><br>
            </div>
            <div id="mission" class="container tab-pane fade"><br>
              ...
              <p class="text-justify"><i class="fas fa-hand-point-right"></i> Providing treatment when it can cure and transform people’s lives.</p><br><br>
            </div>

                                            ...
                                            <table id="table_info" class="table table-bordered table-striped table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($members as $data)
                                                        ...
                                                        <?php
                                                            $tmid = base64_encode($data->id);
                                                        ?>

                                                        <td>
                                                            <a href=" {{ url('/team-update/'.$tmid) }} " class="btn btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>

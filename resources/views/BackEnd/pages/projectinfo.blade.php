                                    ...
                                    <div class="card-content">
                                        <div class='list-group gallery'>
                                            ...
                                            <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                                                <a class="fancybox thumbnail example-image-link image" data-lightbox="example-1"><img class="example-image" src=" {{ asset('BackEnd/project_image/'.$image->filename) }} " alt="image" /></a>

                                            ...
                                            <table id="table_info" class="table table-bordered table-striped table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($want as $data)
                                                        ...
                                                        <td> {{ $data->email }} </td>
                                                        <?php
                                                            $wtid = base64_encode($data->id);
                                                        ?>

                                                        <td>
                                                            <a href=" {{ url('/want-help-info/'.$wtid) }} " class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="right" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach                                            
                                                </tbody>

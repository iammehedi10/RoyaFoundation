                                            ...
                                            <table id="table_info" class="table table-bordered table-striped table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($need as $data)
                                                        ...
                                                        <td> {{ $data->email }} </td>
                                                        <?php
                                                            $ndid = base64_encode($data->id);
                                                        ?>

                                                        <td>
                                                            <a href=" {{ url('/need-help-info/'.$ndid) }} " class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="right" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                        </td>
                                                    </tr>    
                                                    @endforeach                                       
                                                </tbody>

...
Route::get('/project', 'ProjectInfoController@projectShow');
...
Route::get('/video', 'VideoController@add');
Route::post('/video-upload', 'VideoController@store');
Route::get('/video-view', 'VideoController@show');
...
Route::get('/delete-project-info/{id}', 'ProjectInsertController@delete_project');
